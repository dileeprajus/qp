...
//logger.warn("INPU IN NO AUTH PUT: "+input);
var params = {
	input: input /* JSON */
};
// result: STRING
...
logger.warn(input.sourceType+": "+"Put No auth Input : "+JSON.stringify(params));
if(input[input.sourceType+'current_payload_option']==="raw"){
    // result: JSON
    var result = Resources["ContentLoaderFunctions"].PutJSON(params);
    logger.warn(input.sourceType+": "+"Put No auth Response : "+JSON.stringify(result));
