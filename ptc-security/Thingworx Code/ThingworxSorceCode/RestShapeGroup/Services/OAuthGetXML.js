...
//logger.warn(input.data_url+"?access_token="+input.oauth_token_data.access_token);
//var params = {
//	input: input /* JSON */
//};
//// result: STRING
...
logger.warn("Get OAuth XML URL : "+url);
logger.warn(input.sourceType+": "+"Get OAuth XML Response : "+result);
