...
import com.cdee.model.jolt.cardinality.CardinalityCompositeSpec;
...
public class CardinalityTransform implements SpecDriven, Transform {
     ...
     *
     * @throws com.cdee.model.jolt.exception.SpecException for a malformed spec
     */
    @Inject
     ...
     * @throws com.cdee.model.jolt.exception.TransformException for a malformed spec or if there are issues during
     * the transform
     */
    @Override
