...
import com.cdee.model.jolt.chainr.ChainrBuilder;
...
public class Chainr implements Transform, ContextualTransform {
     ...
     * @throws com.cdee.model.jolt.exception.TransformException if the specification is malformed, an operation is not
