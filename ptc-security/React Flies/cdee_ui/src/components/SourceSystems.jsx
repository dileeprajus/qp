...
import AllSourceSystems from './smart/SourceSystems/all';
import { Col, Button, Row, Thumbnail, Modal } from 'react-bootstrap';
...
@observer
class SourceTemplates extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      show: false,
  ...
  componentWillMount() {
    ...
    this.props.generic_master_store.groupType = 'source';
        ...
        <Row>
          <div className="header-fixed">
            <Col xs={12} className="text-align">
              <Navigator history={this.props.history} action={'SourceSystems'} type={'/SourceSystems'} tempStore={this.props.generic_master_store} source={'SourceSystems'}/>
              <h3 className="title-fixed">Source Systems</h3>
            </Col>
          </div>
          <div className="top-align">
          <Col key="NewSourceTemplateForm" xs={12} sm={6} md={6} lg={4}>
          ...
          <Button disabled = {this.state.userCheck === false} className="newthing-button" onClick={this.addButtonClick.bind(this)}>
                  <div style={addStyle} >
                    ...
                    <h1 className="newthing-font">Create Source System</h1>
                  </div>
                </Button>
                </Thumbnail>
            </Col>
            <div className="modal-container">
              <Modal show={this.state.show} onHide={close} container={this} aria-labelledby="contained-modal-title">
                <Modal.Header closeButton>
                  <h4>Create New Source System</h4>
                </Modal.Header>
                <Modal.Body>
                    <GroupNew
                      generic_master_store={this.props.generic_master_store} template={'Source'}
