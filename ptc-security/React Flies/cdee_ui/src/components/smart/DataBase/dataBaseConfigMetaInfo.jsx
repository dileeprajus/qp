...
@observer
class SocketConfigMetaInfo extends React.Component {
  constructor(props) {
    super(props);
    this.name =  this.props.match.params.name;//"NewSocket";
    this.client_store = new SocketStore(this.name)
...
SocketConfigMetaInfo.propTypes = {
  store: React.PropTypes.object
};

export default SocketConfigMetaInfo;
