...
class WeeksSchedule extends React.Component {
  constructor(props) {
    super(props);
  ...
  selectItem(event) {
    ...
    var cronStr = this.scheduler_store.retrunCronExpression('Weeks',
      {
        weeks: this.scheduler_store.currentSelectedWeekDayVal ? this.scheduler_store.currentSelectedWeekDayVal :  this.state.currentSelectedWeekDayVal,
  ...
  onChange(event) {
    var tempStr = this.scheduler_store.currentSelectedWeekDayVal ? this.scheduler_store.currentSelectedWeekDayVal : this.state.currentSelectedWeekDayVal;
    ...
    this.scheduler_store.setvalue('currentSelectedWeekDayVal', tempStr);
    var cronStr = this.scheduler_store.retrunCronExpression('Weeks',
      {
        weeks: this.scheduler_store.currentSelectedWeekDayVal ? this.scheduler_store.currentSelectedWeekDayVal :  this.state.currentSelectedWeekDayVal,
        hours: this.scheduler_store.currentHourScheduleVal ? this.scheduler_store.currentHourScheduleVal : this.state.currentHourScheduleVal,
