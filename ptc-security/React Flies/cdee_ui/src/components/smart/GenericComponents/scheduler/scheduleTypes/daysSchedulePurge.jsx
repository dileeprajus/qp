...
class DaysSchedulePurge extends React.Component {
  constructor(props) {
    super(props);
  ...
  selectItem(event) {
    ...
    var cronStr = this.scheduler_purge_store.retrunCronExpression('Days',
      {
        type: this.scheduler_purge_store.currentSelectedDayType ? this.scheduler_purge_store.currentSelectedDayType : this.state.currentSelectedDayType,
  ...
  onChangeRadio(event) {
    ...
    this.scheduler_purge_store.setvalue('currentSelectedDayType', event.target.value);
    var cronStr = this.scheduler_purge_store.retrunCronExpression('Days',
      {
...
DaysSchedulePurge.propTypes = {
  store: React.PropTypes.object
};

export default DaysSchedulePurge;
