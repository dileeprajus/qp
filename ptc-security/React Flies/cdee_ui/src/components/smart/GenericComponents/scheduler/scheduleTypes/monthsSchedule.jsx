...
class MonthsSchedule extends React.Component {
  constructor(props) {
    super(props);
  ...
  selectItem(event) {
    ...
    var cronStr = this.scheduler_store.retrunCronExpression('Months',
      {
        type: this.scheduler_store.currentSelectedMonthType ? this.scheduler_store.currentSelectedMonthType : this.state.currentSelectedMonthType,
        months: this.scheduler_store.currentMonthScheduleVal ? this.scheduler_store.currentMonthScheduleVal : this.state.currentMonthScheduleVal,
        monthSpecs: this.scheduler_store.currentMonthSpecsScheduleVal ? this.scheduler_store.currentMonthSpecsScheduleVal : this.state.currentMonthSpecsScheduleVal,
        weekDays: this.scheduler_store.currentWeekDayScheduleVal ? this.scheduler_store.currentWeekDayScheduleVal : this.state.currentWeekDayScheduleVal,
  ...
  onChangeRadio(event) {
    ...
    this.scheduler_store.setvalue('currentSelectedMonthType', event.target.value);
    var cronStr = this.scheduler_store.retrunCronExpression('Months',
      {
        type: event.target.value,
        months: this.scheduler_store.currentMonthScheduleVal ? this.scheduler_store.currentMonthScheduleVal : this.state.currentMonthScheduleVal,
        monthSpecs: this.scheduler_store.currentMonthSpecsScheduleVal ? this.scheduler_store.currentMonthScheduleVal : this.state.currentMonthSpecsScheduleVal,
        weekDays: this.scheduler_store.currentWeekDayScheduleVal ? this.scheduler_store.currentWeekDayScheduleVal : this.state.currentWeekDayScheduleVal,
        days: this.scheduler_store.currentDayScheduleVal ? this.scheduler_store.currentDayScheduleVal : this.state.currentDayScheduleVal,
        hours: this.scheduler_store.currentHourScheduleVal ? this.scheduler_store.currentHourScheduleVal : this.state.currentHourScheduleVal,
        minutes: this.scheduler_store.currentMinuteScheduleVal ? this.scheduler_store.currentMinuteScheduleVal : this.state.currentMinuteScheduleVal,
        ...
        <td>
          <FormGroup controlId="formControlsSelect">
            <FormControl
                ...
                onChange={this.selectItem.bind(this)} value={this.scheduler_store.currentMonthScheduleVal ? this.scheduler_store.currentMonthScheduleVal : this.state.currentMonthScheduleVal}
            >
              {monthsScheduleList}
            </FormControl>
          </FormGroup>
        ...
        <td>
          <FormGroup controlId="formControlsSelect">
            <FormControl
                ...
                onChange={this.selectItem.bind(this)} value={this.scheduler_store.currentMonthSpecsScheduleVal ? this.scheduler_store.currentMonthSpecsScheduleVal : this.state.currentMonthSpecsScheduleVal}
            >
              {monthSpecsList}
            </FormControl>
          </FormGroup>
        ...
        <td>
          <FormGroup controlId="formControlsSelect">
            <FormControl
                ...
                onChange={this.selectItem.bind(this)} value={this.scheduler_store.currentWeekDayScheduleVal ? this.scheduler_store.currentWeekDayScheduleVal : this.state.currentWeekDayScheduleVal}
            >
              {weekDaysList}
            </FormControl>
          </FormGroup>
...
MonthsSchedule.propTypes = {
  store: React.PropTypes.object
};

export default MonthsSchedule;
