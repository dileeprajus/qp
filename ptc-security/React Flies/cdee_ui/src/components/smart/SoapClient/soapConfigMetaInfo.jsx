...
@observer
class SoapConfigMetaInfo extends React.Component {
  constructor(props) {
    super(props);
    this.name =  this.props.match.params.name;
    this.client_store = new SoapClientStore(this.name)
    ...
    return (
      <div>
        ...
        <ModalInstance
          ...
          modal_btn_text={'Update'} configName={this.props.match.params.name}
        />
...
SoapConfigMetaInfo.propTypes = {
  store: React.PropTypes.object
};

export default SoapConfigMetaInfo;
