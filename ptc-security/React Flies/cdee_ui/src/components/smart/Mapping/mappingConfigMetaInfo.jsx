...
@observer
class MappingConfigMetaInfo extends React.Component {
  constructor(props) {
    super(props);
    this.name =  this.props.match.params.name;
    this.client_store = new MappingStore(this.props.match.params.name)
    ...
    return (
      <div>
        <Row>
          <Grid>
            <Col xs={8} xsOffset={2}>
              <h4>Update {this.props.match.params.name} Config Info</h4>
              <Thumbnail>
                <form onSubmit={this.handleSubmit}>
                  ...
                  <CodeMirror id="metaConfig" onChange={this.onChange.bind(this)} value={JSON.stringify(this.client_store.configMetaInfo?this.client_store.configMetaInfo:{}, null, 2)} options={codeOptions}/>
                  </FormGroup>
                  <FormGroup>
...
MappingConfigMetaInfo.propTypes = {
  store: React.PropTypes.object
};

export default MappingConfigMetaInfo;
