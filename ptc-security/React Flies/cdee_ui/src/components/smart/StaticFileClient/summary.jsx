...
@observer
class SaticFileClientSummary extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    return (
      <div>
        <div>
          <Navigator history={this.props.history} action={'Transactions'} type={'/StaticFileClient'} tempStore={this.static_file_client_store} source={'Thing'} />
        </div>
        <div className="summury-alignment">
          <TransactionSummary temp_store={this.static_file_client_store} generic_master_store={this.props.generic_master_store} />
        </div>
      </div>
    );
  }
...
SaticFileClientSummary.propTypes = {
  store: React.PropTypes.object
};

export default SaticFileClientSummary;
